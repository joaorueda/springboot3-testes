...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo 400 quando informacoes estao incorretas")
    @WithMockUser
    ...
    void agendar_cenario2() throws Exception {
        ...
        var jsonEsperado = dadosDetalhamentoConsultasJson.write(dadosDetalhamento).getJson();
